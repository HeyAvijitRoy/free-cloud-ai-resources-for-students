# Student Tools — Free & Discounted Resources

<!-- CATEGORY BANNERS (Dark-mode optimized) -->
![Developer Tools](https://img.shields.io/badge/Developer%20Tools-000000?style=flat&logo=github)
![Cloud Platforms](https://img.shields.io/badge/Cloud%20Credits-111111?style=flat&logo=microsoftazure)
![AI/ML Tools](https://img.shields.io/badge/AI%2FML%20Tools-0d0d0d?style=flat&logo=googlecloud)
![Databases](https://img.shields.io/badge/Databases-1a1a1a?style=flat&logo=mongodb)
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-222222?style=flat&logo=protonvpn)
![Design Tools](https://img.shields.io/badge/Design%20%2F%20Creative-000000?style=flat&logo=figma)
![Productivity](https://img.shields.io/badge/Productivity-111111?style=flat&logo=notion)
![Learning Platforms](https://img.shields.io/badge/Learning%20Platforms-1a1a1a?style=flat&logo=readthedocs)

A curated list of free and discounted tools for students.  
Descriptions match the exact text on the live page below.

📌 **Live on my website:**  
https://www.avijitroy.com/teaching/student-tools/

---

# 🎯 Purpose

This repository maintains a **curated, community-driven list of free and discounted tools available to students** across development, AI/ML, cloud computing, cybersecurity, design, and productivity.

**The mission is simple:**

- Help students build real projects at **zero cost**  
- Provide access to **professional-grade tools**  
- Centralize all free credits and student benefits in one place  
- Encourage community contributions to keep this list up-to-date  
- Support students learning software engineering, AI, ML, cybersecurity, cloud, UI/UX, and more  

This list powers the live student tools page on:  
**https://www.avijitroy.com/teaching/student-tools/**
...
- **No affiliate links. No referrals. No tracking.**  
  Every link points directly to the official provider website.

- Benefits, credits, and eligibility requirements can **change at any time**.  
  Always verify details directly from the provider before signing up.

- This repository is maintained in good faith, but **accuracy is not guaranteed**.
...
- [Cloud Platforms & Compute Credits](#cloud-platforms--compute-credits)
- [AI/ML Tools & Free GPU Access](#aiml-tools--free-gpu-access)
- [Databases & Storage](#databases--storage)
- [DevOps Monitoring & Deployment](#devops-monitoring--deployment)
- [Learning Platforms & Certifications](#learning-platforms--certifications)
...
- [Best Strategy for Students](#best-strategy-for-students)
...
2. Activate **Azure + AWS + GCP free tiers**  
3. Use **JetBrains / VS / Replit**  
4. Train ML on **Kaggle / Colab / SageMaker**  
5. Deploy using **DigitalOcean / Azure / Heroku**  
6. Store data in **MongoDB / Firebase / S3**  
7. Monitor with **Sentry**  
8. Earn certifications  
9. Design top-tier visuals with **Figma / Canva**
...
If you know about **any free student tools, cloud credits, or high-value resources**, please contribute!

### ✔️ How to contribute  
1. Fork this repo  
2. Add tools or update existing ones using the same structure:
...
4. Once approved, your name + GitHub profile link will be added to the **Credits** section  
5. Your additions will automatically appear on the **live website page**  

### ✔️ What to contribute  
- Free developer tools  
- AI/ML tools and free GPU resources  
- Cloud compute credits  
- Design/creative tools  
- Cybersecurity learning labs  
- Productivity tools  
- Any platform that helps students **build, learn, or grow**  
...
### **Maintainer**
- **Avijit Roy** — https://www.avijitroy.com/

### **Contributors**  
(Your name + GitHub link will appear here after your PR is merged.)

> Want your name here? Add tools → open a PR → get credited.
